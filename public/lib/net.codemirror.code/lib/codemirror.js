...
window.CodeMirror = (function() {
  ...
  function makeDisplay(place, docStart) {
    ...
    // d.heightForcer = elt("div", null, null, "position: absolute; height: " + scrollerCutOff + "px; width: 1px;"); // remove because it increases window editor height about 30px forcibly;
    // Will contain the gutters, if any
    d.gutters = elt("div", null, "CodeMirror-gutters");
    d.lineGutter = null;
    // Helper element to properly size the gutter backgrounds
    // var scrollerInner = elt("div", [d.sizer, d.heightForcer, d.gutters], null, "position: relative; min-height: 100%");
    var scrollerInner = elt("div", [d.sizer, d.gutters], null, "position: relative; min-height: 100%"); // remove d.heightForcer
    // Provides scrolling
  ...
  function updateScrollbars(d /* display */, docHeight) {
    ...
    d.sizer.style.minHeight = totalHeight + "px"; // remove d.heightForcer
