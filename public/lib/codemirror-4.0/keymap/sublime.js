...
(function(mod) {
  ...
  // map[ctrl + "/"] = "toggleComment"; // jeongmin: no need
  ...
  // cmds[map["F2"] = "nextBookmark"] = function(cm) { // jeongmin: no need
  ...
  // cmds[map["Shift-F2"] = "prevBookmark"] = function(cm) { // jeongmin: no need
  //   var marks = cm.state.sublimeBookmarks;
  //   if (marks) while (marks.length) {
  ...
  // cmds[map[ctrl + "F2"] = "toggleBookmark"] = function(cm) { // jeongmin: no need
  ...
  // cmds[map["Shift-" + ctrl + "F2"] = "clearBookmarks"] = function(cm) { // jeongmin: no need
  //   var marks = cm.state.sublimeBookmarks;
